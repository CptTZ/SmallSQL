...
public class TestDBMetaData extends BasicTestCase {
    ...
    public void testVersions() throws Exception {
        ...
        assertEquals(new DecimalFormat("###0.00", new DecimalFormatSymbols(Locale.US)).format(driver.getMajorVersion() + driver.getMinorVersion() / 100.0), md.getDriverVersion());
    ...
    public void testFunctions() throws Exception {
        ...
        assertEquals("ASCII,BIT_LENGTH,CHAR_LENGTH,CHARACTER_LENGTH,CHAR,CONCAT,DIFFERENCE,INSERT,LCASE,LEFT,LENGTH,LOCATE,LTRIM,OCTET_LENGTH,REPEAT,REPLACE,RIGHT,RTRIM,SOUNDEX,SPACE,SUBSTRING,TRIM,UCASE",
                md.getStringFunctions());
        assertEquals("IFNULL,USER,CONVERT,CAST,IIF",
                md.getSystemFunctions());
        assertEquals("CURDATE,CURRENT_DATE,CURTIME,DAYNAME,DAYOFMONTH,DAYOFWEEK,DAYOFYEAR,DAY,HOUR,MILLISECOND,MINUTE,MONTH,MONTHNAME,NOW,QUARTER,SECOND,TIMESTAMPADD,TIMESTAMPDIFF,WEEK,YEAR",
